      ...
      <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
        ...
        >
          <svg
            ...
            strokeWidth={2}
            className="w-10 h-10 text-white p-2 bg-yellow-700 rounded-full"
            viewBox="0 0 24 24"
          >
        ...
        <Link
          to={"/"}
          className="inline-flex items-center text-white bg-yellow-700 border-0 py-2 px-4 focus:outline-none hover:bg-yellow-600 rounded text-base mt-4 md:mt-0"
        >
          Login
          <svg
            fill="none"
